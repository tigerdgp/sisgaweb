{include file='header.tpl'}
        <h1>Meu Perfil</h1>
        <div class="edit"><a href="?editar_perfil&u={$edit_user}&etapa=1" title="Editar Informações">Editar Informações</a></div>
        <div class="p_perfil">
            ...
            <div class="p_perfil_b">
                ...
                {section name=c loop=$contato}
                    ...
                    <div class="p_perfil_dados2">
                        ...
                        <p><span>Telefone Fixo:</span> {$contato[c].telefone1|phone_format}</p>
                        <p><span>Telefone Celular:</span> {$contato[c].telefone2|phone_format}</p>
                        <p><span>Telefone Celular:</span> {$contato[c].telefone3|phone_format}</p>
                    </div>
                {/section}
                <div class="clear"></div>
            </div>            
